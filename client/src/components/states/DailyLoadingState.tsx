/**
 * Daily Brain Loading State
 */

import { motion } from 'framer-motion';
import { Brain, ListOrdered, Clock, Lightbulb, AlertTriangle } from 'lucide-react';
...
export function DailyLoadingState() {
  return (
    <motion.div
    ...
    >
      <div className="text-center py-8">
        ...
        <p className="text-sm text-text-muted mb-8">
          Building a habit-forming routine... (8-15s)
        </p>
